...
const PulseCallButton: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="relative transition-all duration-300 ease-out transform group-hover:-translate-y-2 group-hover:scale-[1.05] animate-wiggle-7s group-hover:animate-none
        ...
        <div className="absolute inset-0 bg-brand-dark rounded-[16px] md:rounded-[19px] overflow-hidden flex flex-col items-center w-full h-full border-[1px] border-black">
            ...
            <div className="flex flex-col items-center w-full h-full pt-5 md:pt-6 pb-3 z-10 justify-between">
                ...
                <div className="mb-2 md:mb-2.5">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-green-500 rounded-full flex items-center justify-center shadow-[0_4px_12px_rgba(34,197,94,0.4)] group-hover:bg-white transition-colors duration-300 border border-white/10 animate-pulse-slow">
                        <svg 
