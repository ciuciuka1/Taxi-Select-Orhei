...
export const translations: Record<Language, TranslationStructure> = {
  ro: {
    ...
    weather: {
      ...
      rainMod: "Ploaie Moderată",
      rainHeavy: "Ploaie Torențială",
      snowLight: "Ninsoare Slabă",
      snowMod: "Ninsoare Moderată",
      snowHeavy: "Ninsoare Abundentă",
      hail: "Grindină",
      showersLight: "Averse Slabe",
      showersMod: "Averse Moderate",
  ...
  ru: {
    ...
    weather: {
      ...
      drizzleMod: "Умеренная Морось",
      drizzleDense: "Сильная Морось",
      freezingRain: "Ледяной Дождь",
      rainLight: "Слабый Дождь",
      rainMod: "Умеренный Дождь",
      rainHeavy: "Ливень",
      snowLight: "Слабый Снег",
      snowMod: "Умеренный Снег",
      snowHeavy: "Сильный Снегопад",
      hail: "Град",
      showersLight: "Слабый Ливень",
      showersMod: "Умеренный Ливень",
