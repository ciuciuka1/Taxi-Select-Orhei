  ...
  return (
    <>
      <SeoHead 
        ...
        description="Contact Taxi Select Orhei. Phone: 0 235 66 6 66. Adresă: Orhei, Strada Vasile Lupu. Disponibil 24/7."
        path="contact"
      />
      <div className="pt-32 pb-20 px-4 md:px-6 relative z-10 bg-brand-dark min-h-screen flex items-center">
        <div className="container mx-auto max-w-3xl text-center">
          <section className="bg-brand-slate/80 backdrop-blur-md border border-white/10 p-8 md:p-12 rounded-2xl shadow-2xl relative overflow-hidden" aria-labelledby="contact-heading">
             ...
             <div className="relative z-10 mb-6">
                <a 
                   ...
                   id="contact-heading"
                   aria-label="Sună acum pentru comandă taxi"
                >
                   {t.contact.title}
                </a>
             </div>
             ...
             <div className="flex flex-col items-center justify-center space-y-4 mb-12 relative z-10 group/phone">
                <a 
                   ...
                   aria-label="Număr Telefon Taxi Orhei 0235 66 6 66"
                >
                   66 6 66
                </a>
             ...
             <div className="flex justify-center mb-12 relative z-10 w-full px-2 md:px-0">
                <a 
                   ...
                   "
                   aria-label="Buton Apel Verde 0235 66 6 66"
                >
                   ...
                   <svg className="w-6 h-6 md:w-8 md:h-8 fill-current shrink-0 animate-vibrate-smooth relative z-10" viewBox="0 0 24 24" aria-hidden="true">
